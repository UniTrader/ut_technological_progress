                        ...
                        <xsl:otherwise>
                          <xsl:copy>
                            ...
                            <xsl:for-each select="./progression/@*">
                              <xsl:attribute name="{name()}">
                                <xsl:choose>
                                  <!-- Expotential Progression (0 - 200 % of previous level value) if Progression Value is between 0 and 2, otherwise Linear progression with each level (progress value is added per level-->
                                  <xsl:when test=". &gt; 0 and . &lt; 2">
